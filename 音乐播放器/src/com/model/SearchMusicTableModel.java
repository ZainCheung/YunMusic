...
public class SearchMusicTableModel extends AbstractTableModel implements TableCellRenderer {
	...
	// 序号,标题.歌手,专辑,时长,大小 这个数组的长度就是表格的列数
	public int[] columnWidth = { 77, 77, 376, 262, 350, 122 };// 本地歌曲列表每列初始宽度
