...
public class CustomFileChooser extends JFileChooser {
	...
	public static void main(String[] args) {
		...
		setUIFont(new Font("微软雅黑", Font.PLAIN, 20));

		CustomFileChooser chooser = new CustomFileChooser("D://");//打开初始路径
		chooser.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);//只能选择文件夹
		//chooser.showOpenDialog(null);
		
		int val = chooser.showDialog(null,"打开");//= 0; 
		// AllPanel.fileChooser.getComponent(AllPanel.fileChooser.APPROVE_OPTION)
		if (val == JFileChooser.APPROVE_OPTION) {
			File selectedFile = chooser.getSelectedFile(); // 取得选中的文件
	...
	public CustomFileChooser() {
		super();
		setUIFont(new Font("", Font.PLAIN, 24));
	}
	...
	public CustomFileChooser(String currentDirectoryPath) {
		...
		while (keys.hasMoreElements()) {
			...
			if (value instanceof FontUIResource) {
				UIManager.put(key, new Font("", Font.PLAIN, 24));
			}
		}
		//setUIFont(new Font("", Font.PLAIN, 24));
	}
	...
	public static class CustomFileChooserUI extends BasicFileChooserUI {
		...
		private static Font labelFont14 = new Font(Font.DIALOG, Font.PLAIN, 20);// 标签字体大小,初始值为14
		private static Font labelFont12 = new Font(Font.DIALOG, Font.PLAIN, 18);// 文本框字体大小,初始值为12
		...
		private static final Dimension hstrut5 = new Dimension(10, 1);// 5,1
		// private static final Dimension hstrut11 = new Dimension(11, 1);

		private static final Dimension vstrut5 = new Dimension(1, 5);// 1,5

		private static final Insets shrinkwrap = new Insets(0, 0, 0, 0);

		// Preferred and Minimum sizes for the dialog box
		private static int PREF_WIDTH = 500;// 选择器初始宽度500
		private static int PREF_HEIGHT = 700;// 选择器初始高度326
		private static Dimension PREF_SIZE = new Dimension(PREF_WIDTH, PREF_HEIGHT);

		private static int MIN_WIDTH = 500;// 500
		private static int MIN_HEIGHT = 326;// 326
		private static Dimension MIN_SIZE = new Dimension(MIN_WIDTH, MIN_HEIGHT);

		private static int LIST_PREF_WIDTH = 405;// 405
		private static int LIST_PREF_HEIGHT = 135;// 135
		...
		public void installComponents(JFileChooser fc) {
			...
			fc.setBorder(new EmptyBorder(12, 12, 11, 11));// 12,12,11,11
			fc.setLayout(new BorderLayout(11, 11));// 0,11
			...
			JPanel topPanel = new JPanel(new BorderLayout(11, 0));// 11,0
			...
			directoryComboBox.setMaximumRowCount(20);// 下拉框最多展示项数 8
		...
		public static RolloverBackgroundButton createRolloverBackgroundButton(String text) {
			...
			button.setFont(new Font(Font.DIALOG, Font.PLAIN, 20));// 按钮字体大小,16
			return button;
		}
		...
		protected JButton getButton(Icon icon, Action action) {
			...
			button.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(boxBorderColor),
		 ...
		 * 
		 * @param c a <code>JFileChooser</code>
		 * @return a <code>Dimension</code> specifying the minimum width and height of
		 *         the file chooser
		 */
		 ...
		 * 
		 * @param c a <code>JFileChooser</code>
		 * @return a <code>Dimension</code> specifying the maximum width and height of
		 *         the file chooser
		 */
		...
		/*
		 * Listen for filechooser property changes, such as the selected file changing,
		 * or the type of the dialog changing.
		 */
		...
		protected class DirectoryComboBoxModel extends AbstractListModel<Object> implements ComboBoxModel<Object> {
			 ...
			 * clears out the previous selected directory and the paths leading up to it, if
			 * any.
			 */
